...
*/
  ...
  function na(a) {
    ...
    Object.assign || (Object.assign = function (a, b) {
      for (var c = [
      ].slice.call(arguments, 1), d = 0, e; d < c.length; d++) if (e = c[d]) for (var f = a, m = e, n = Object.getOwnPropertyNames(m), t = 0; t < n.length; t++) e = n[t],
      f[e] = m[e];
      return a
    })
  ...
  (function () {
    ...
    /Trident/.test(navigator.userAgent) && function () {
      function a(a, b) {
        if (a instanceof DocumentFragment) for (var d; d = a.firstChild; ) c.call(this, d, b);
    ...
    if (c) {
      ...
      var hf = ba('area base br col command embed hr img input keygen link meta param source track wbr'.split(' ')),
          ...
          a: {
            ...
            switch (g.nodeType) {
              case Node.ELEMENT_NODE:
                for (var m = g.localName, n = '<' + m, ya = g.attributes, Ma = 0; k = ya[Ma]; Ma++) n += ' ' + k.name + '="' + k.value.replace(wa, ka) + '"';
                n += '>';
                g = hf[m] ? n : n + nb(g, l) + '</' + m + '>';
                break a;
              case Node.TEXT_NODE:
    ...
    if (c || aa) {
      ...
      var ya = function (c, d) {
        if (d.querySelectorAll && (d = b(d, 'template'), 0 !== d.length)) {
          c = b(c, 'template');
          for (var e = 0, f = c.length, h, g; e < f; e++) g = d[e],
          h = c[e],
          a && a.H && a.H(g),
      ...
      Ma = Node.prototype.cloneNode = function (b) {
        if (!e && d && this instanceof DocumentFragment) if (b) var c = jf.call(this.ownerDocument, this, !0);
         else return this.ownerDocument.createDocumentFragment();
         else c = this.nodeType === Node.ELEMENT_NODE && 'template' === this.localName && this.namespaceURI == document.documentElement.namespaceURI ? a.ha(this, b)  : f.call(this, b);
        b && ya(c, this);
        return c
      },
      jf = Document.prototype.importNode = function (c, d) {
        ...
        if (d) {
          ...
          for (var f, k = 0; k < c.length; k++) {
            ...
            for (var l = f.attributes, ka = 0, xa; ka < l.length; ka++) xa = l[ka],
            d.setAttribute(xa.name, xa.value);
  ...
  ua = 'undefined' !== typeof Uint8ClampedArray && 'undefined' !== typeof importScripts && 'undefined' !== typeof MessageChannel;
  function za() {
  ...
  var Ea = Array(1000);
  function Aa() {
    for (var a = 0; a < pa; a += 2) (0, Ea[a]) (Ea[a + 1]),
    Ea[a] = void 0,
    Ea[a + 1] = void 0;
    pa = 0
  }
  var Fa,
  Ga;
  if ('undefined' === typeof self && 'undefined' !== typeof process && '[object process]' === {
  }.toString.call(process)) Ga = function () {
    ...
    if (ta) Ha = Ca();
      ...
      if (ua) Ia = Da();
        ...
        var Ja;
        if (void 0 === ra && 'function' === typeof require) try {
  ...
  function eb(a) {
    ...
    c = a.h;
    if (0 !== b.length) {
      for (var d, e, f = a.f, h = 0; h < b.length; h += 3) d = b[h],
      e = b[h + c],
      d ? Ta(c, d, e, f)  : e(f);
      a.L.length = 0
    }
  ...
  function ib(a, b) {
    ...
    this.D = new a(Qa);
    this.D[Ra] || Sa(this.D);
    if (oa(b)) if (this.U = this.length = b.length, this.f = Array(this.length), 0 === this.length) r(this.D, this.f);
     else {
...
*/
  ...
  (function (a) {
    ...
    function h(a, b) {
      if (a.__loaded) b && b();
       else if ('script' === a.localName && !a.src || 'style' === a.localName && !a.firstChild) a.__loaded = !0,
      b && b();
       else {
        var c = function (d) {
    ...
    k.prototype.Wa = function (a, b) {
      ...
      l(a);
       else for (a = document.createDocumentFragment(); c.firstChild; ) a.appendChild(c.firstChild);
      if (c = a.querySelector('base')) b = D.aa(c.getAttribute('href'), b),
    ...
    var wa = null;
    if (C) t = m(document, 'link[rel=import]'),
    n(t, function (a) {
...
*/
  ...
  if (!w.noOpts) {
    ...
    if (qb) for (var sb = 0, tb; tb = qb.attributes[sb]; sb++) 'src' !== tb.name && (w[tb.name] = tb.value || !0);
  ...
  var vb = w.shadydom;
  vb && (window.ShadyDOM = window.ShadyDOM || {
  }, window.ShadyDOM.force = vb);
...
*/
  ...
  Eb = Db.matches || Db.matchesSelector || Db.mozMatchesSelector || Db.msMatchesSelector || Db.oMatchesSelector || Db.webkitMatchesSelector;
  function Fb(a, b) {
  ...
  function Xb(a, b) {
    ...
    return a.map(function (a) {
      ...
      if (b && a.addedNodes) {
        ...
        }), b.length) return a = Object.create(a),
  ...
  var vc = uc('area base br col command embed hr img input keygen link meta param source track wbr'.split(' ')),
  wc = uc('style script xmp iframe noembed noframes plaintext noscript'.split(' '));
  function xc(a, b) {
    'template' === a.localName && (a = a.content);
    for (var c = '', d = b ? b(a)  : a.childNodes, e = 0, f = d.length, h; e < f && (h = d[e]); e++) {
      a: {
        ...
        switch (g.nodeType) {
          case Node.ELEMENT_NODE:
            for (var m = g.localName, n = '<' + m, t = g.attributes, C = 0; k = t[C]; C++) n += ' ' + k.name + '="' + k.value.replace(rc, tc) + '"';
            n += '>';
            g = vc[m] ? n : n + xc(g, l) + '</' + m + '>';
            break a;
          case Node.TEXT_NODE:
  ...
  Lc = {
    ...
    innerHTML: {
      ...
      set: function (a) {
        ...
        for (Ec ? H.wa.innerHTML.set.call(c, a)  : c.innerHTML = a; c.firstChild; ) b.appendChild(c.firstChild)
      },
      configurable: !0
    }
  },
  ...
  function Vc(a, b) {
    var c = x(a);
    if (void 0 === c.firstChild) for (b = b || Tc(a), c.firstChild = b[0] || null, c.lastChild = b[b.length - 1] || null, Sc(a), c = 0; c < b.length; c++) {
      var d = b[c],
      e = x(d);
      e.parentNode = a;
  ...
  function Xc(a, b, c) {
    ...
    if (c) {
      var d = y(c);
      d = d && d.parentNode;
      if (void 0 !== d && d !== a || void 0 === d && Wc(c) !== a) throw Error('Failed to execute \'insertBefore\' on \'Node\': The node before which the new node is to be inserted is not a child of this node.');
    }
    if (c === b) return b;
    ...
    if (!b.__noInsertionPoint) {
      ...
      ].concat(d instanceof Array ? d : na(ma(d)))))
  ...
  function Yc(a, b) {
    ...
    if (c) {
      ...
      if (c.g) {
        dd(c);
        f = c.j;
        for (aa in f) for (h = f[aa], g = 0; g < h.length; g++) {
          var l = h[g];
          if (Nb(b, l)) {
            h.splice(g, 1);
            var m = c.g.indexOf(l);
            ...
            g--;
            m = y(l);
            if (l = m.C) for (var n = 0; n < l.length; n++) {
              var t = l[n],
              C = ed(t);
  ...
  function bd(a, b, c) {
    if (a = (a = y(a)) && a.J) b && a.addedNodes.push(b),
  ...
  function od(a, b) {
    ...
    if (b) {
      a = a.childNodes;
      b = 0;
      for (var d; b < a.length; b++) d = od(a[b], !0),
      c.appendChild(d)
    }
    return c
  };
  ...
  function rd(a, b) {
    ...
    d = a;
    for (a = a === window ? window : a.getRootNode(); d; ) c.push(d),
    d = d.assignedSlot ? d.assignedSlot : d.nodeType === Node.DOCUMENT_FRAGMENT_NODE && d.host && (b || d !== a) ? d.host : d.parentNode;
  ...
  function sd(a, b) {
    if (!A) return a;
    a = rd(a, !0);
    for (var c = 0, d, e, f, h; c < b.length; c++) if (d = b[c], f = d === window ? window : d.getRootNode(), f !== e && (h = a.indexOf(f), e = f), !A(f) || - 1 < h) return d
  }
  var td = {
    get composed() {
  ...
  function xd(a, b, c) {
    if (c = b.__handlers && b.__handlers[a.type] && b.__handlers[a.type][c]) for (var d = 0, e; (e = c[d]) && (!wd(a) || a.target !== a.relatedTarget) && (e.call(b, a), !a.i); d++);
  }
  function yd(a) {
    ...
    for (c = 0; c < b.length; c++) {
      ...
      var f = y(d);
      f = f && f.root;
      if (0 === c || f && f === e) if (xd(a, d, 'bubble'), d !== window && (e = d.getRootNode()), a.a) break
    }
  }
    ...
    if (b) {
      ...
      if ('function' === d || 'object' === d) if ('object' !== d || b.handleEvent && 'function' === typeof b.handleEvent) {
        ...
        k = function (e) {
          ...
          if (e.composed || - 1 < e.composedPath().indexOf(g)) if (wd(e) && e.target === e.relatedTarget) e.eventPhase === Event.BUBBLING_PHASE && e.stopImmediatePropagation();
        ...
        vd[a] ? (this.__handlers = this.__handlers || {
        }, this.__handlers[a] = this.__handlers[a] || {
          capture: [
          ],
          bubble: [
          ]
        }, this.__handlers[a][e ? 'capture' : 'bubble'].push(k))  : (this instanceof Window ? B.fb : B.addEventListener).call(this, a, k, c)
      }
    }
  }
  function Cd(a, b, c) {
  ...
  function Dd() {
    for (var a in vd) window.addEventListener(a, function (a) {
  ...
  function Id(a, b, c, d) {
    ...
    g = b - k + 1;
    b = Array(d);
    for (l = 0; l < d; l++) b[l] = Array(g),
    b[l][0] = l;
    for (l = 0; l < g; l++) b[0][l] = l;
    for (l = 1; l < d; l++) for (m = 1; m < g; m++) if (a[k + m - 1] === c[h + l - 1]) b[l][m] = b[l - 1][m - 1];
     else {
      var n = b[l - 1][m] + 1,
      t = b[l][m - 1] + 1;
      b[l][m] = n < t ? n : t
    ...
    d = b[k][h];
    for (a = [
    ]; 0 < k || 0 < h; ) 0 == k ? (a.push(2), h--)  : 0 == h ? (a.push(3), k--)  : (g = b[k - 1][h - 1], l = b[k - 1][h], m = b[k][h - 1], n = l < m ? l < g ? l : g : m < g ? m : g, n == g ? (g == d ? a.push(0)  : (a.push(1), d = g), k--, h--)  : n == l ? (a.push(3), k--, d = l)  : (a.push(2), h--, d = m));
    a.reverse();
    b = void 0;
    k = [
    ];
  ...
  function Nd(a) {
    for (var b; a; ) {
      ...
      a: {
        ...
        if (A(a)) for (var d = c.host.childNodes, e = 0; e < d.length; e++) if (c = d[e], 'slot' == c.localName) break a;
        a = void 0
      }
    }
    b && b._renderRoot()
  ...
  Qc.prototype._renderRoot = function () {
    ...
    if (this.g) {
      ...
      for (var a = 0, b; a < this.g.length; a++) {
        ...
        if (c.la = d) for (c = 0; c < d.length; c++) {
          var e = y(d[c]);
          e.T = e.assignedSlot;
      ...
      for (a = 0; a < this.g.length; a++) {
        b = this.g[a];
        d = y(b);
        if (!d.assignedNodes.length) for (c = b.firstChild; c; c = c.nextSibling) Od(this, c, b);
      ...
      for (d = 0; d < a.length; d++) c = a[d].parentNode,
      ...
      for (a = 0; a < b.length; a++) {
        ...
        for (var k = g = 0; g < h.length && (d = h[g]); g++) {
          for (var l = 0, m; l < d.P.length && (m = d.P[l]); l++) ed(m) === c && B.removeChild.call(c, m),
          f.splice(d.index + k, 1);
          k -= d.W
        }
        for (k = 0; k < h.length && (d = h[k]); k++) for (g = f[d.index], l = d.index; l < d.index + d.W; l++) m = e[l],
        B.insertBefore.call(c, m, g),
        f.splice(l, 0, m)
      }
    }
  };
  ...
  function id(a) {
    return a.sort(function (a, c) {
      ...
      for (var b = Md(c), e = 0; e < a.length; e++) {
        c = a[e];
        var f = b[e];
        if (c !== f) return a = Array.from(c.parentNode.childNodes),
  ...
  Object.defineProperties(Td, {
    isConnected: {
      get: function () {
        ...
        } else if (a.documentElement && B.contains.call(a.documentElement, this)) return !0;
  ...
  Object.defineProperties(Yd, {
    _activeElement: Nc.activeElement
  });
    ...
    for (var d = a; d; ) {
      if (d.nodeType === Node.ELEMENT_NODE) {
        ...
        if ('link' === f && 'import' === e.getAttribute('rel')) {
          d = e.import ;
          if (d instanceof Node && !c.has(d)) for (c.add(d), d = d.firstChild; d; d = d.nextSibling) fe(d, b, c);
          d = ee(a, e);
          continue
        } else if ('template' === f) {
          d = ee(a, e);
        ...
        if (e = e.__CE_shadowRoot) for (e = e.firstChild; e; e = e.nextSibling) fe(e, b, c)
      }
  ...
  le.prototype.b = function (a) {
    ...
    for (b = 0; b < a.length; b++) for (var c = a[b].addedNodes, d = 0; d < c.length; d++) S(this.l, c[d])
  };
  function me() {
    var a = this;
  ...
  p.define = function (a, b) {
    ...
    if (!de(a)) throw new SyntaxError('The element name \'' + a + '\' is not valid.');
    if (this.l.a.get(a)) throw Error('A custom element with name \'' + a + '\' has already been defined.');
  ...
  function ne(a) {
    if (!1 !== a.S) {
      a.S = !1;
      for (var b = a.ka, c = [
      ], d = new Map, e = 0; e < b.length; e++) d.set(b[e].localName, [
      ]);
      S(a.l, document, {
        ba: function (b) {
          if (void 0 === b.__CE_state) {
  ...
  p.Ba = function (a) {
    if (!de(a)) return Promise.reject(new SyntaxError('\'' + a + '\' is not a valid custom element name.'));
    var b = this.ma.get(a);
    if (b) return b.c;
    b = new me;
    this.ma.set(a, b);
  ...
  Se = Object.getOwnPropertyDescriptor(window.HTMLElement.prototype, 'innerHTML'),
  ...
  function We() {
    ...
    window.HTMLElement = function () {
      function b() {
        ...
        if (0 === e.length) return e = oe.call(document, d.localName),
        ...
        d = e.length - 1;
        var f = e[d];
        if (f === Ve) throw Error('The HTMLElement constructor was either called reentrantly for this constructor or called multiple times.');
        e[d] = Ve;
  ...
  function Ye(a, b, c) {
    function d(b) {
      return function (c) {
        ...
        if (N(this)) for (d = 0; d < e.length; d++) f = e[d],
        f instanceof Element && Q(a, f)
      }
    }
  ...
  function $e() {
    ...
    O(Node.prototype, 'cloneNode', function (b) {
      b = ve.call(this, b);
      this.ownerDocument.__CE_hasRegistry ? S(a, b)  :
      je(a, b);
      return b
    });
  ...
  function af(a) {
    ...
    function c(b) {
      return function (c) {
        ...
        if (N(this)) for (d = 0; d < e.length; d++) g = e[d],
        g instanceof Element && Q(a, g)
      }
    }
    void 0 !== Ne && (b.before = c(Ne));
    void 0 !== Ne && (b.after = c(Oe));
    void 0 !==
    Pe && O(b, 'replaceWith', function (b) {
      for (var c = [
      ], d = 0; d < arguments.length; ++d) c[d - 0] = arguments[d];
      d = [
      ];
      for (var h = [
      ], g = 0; g < c.length; g++) {
      ...
      if (g) for (R(a, this), c = 0; c < d.length; c++) h = d[c],
      h instanceof Element && Q(a, h)
    });
  ...
  function bf() {
    ...
    function d(b, c) {
      ...
      O(b, 'insertAdjacentHTML', function (a, b) {
        ...
        } else if ('afterbegin' === a) e = this.firstChild,
        c.call(this, a, b),
        d(this.firstChild, e);
         else if ('beforeend' === a) e = this.lastChild,
        c.call(this, a, b),
        d(e || this.firstChild, null);
         else if ('afterend' === a) e = this.nextSibling,
        c.call(this, a, b),
    ...
    Ce && Ce.get ? b(Element.prototype, Ce)  : Se && Se.get ? b(HTMLElement.prototype, Se)  : ie(a, function (a) {
      b(a, {
        ...
        set: function (a) {
          ...
          for (d.innerHTML = a; 0 < c.childNodes.length; ) ye.call(c, c.childNodes[0]);
          for (a = b ? d.content : d; 0 < a.childNodes.length; ) we.call(c, a.childNodes[0])
        }
      })
    });
  ...
  if (!cf || cf.forcePolyfill || 'function' != typeof cf.define || 'function' != typeof cf.get) {
    ...
    We();
    Ze();
    Ye(Xe, DocumentFragment.prototype, {
      $: te,
      append: ue
    });
    $e();
  ...
  function kf(a, b) {
    ...
    if (c = a.rules) for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) kf(f, b);
    return a
  }
  function lf(a) {
  ...
  function sf(a, b, c) {
    ...
    if (a.cssText || a.rules) {
      ...
      } else b ? b = a.cssText : (b = a.cssText, b = b.replace(tf, '').replace(uf, ''), b = b.replace(vf, '').replace(wf, '')),
      (d = b.trim()) && (d = '  ' + d + '\n')
    }
  ...
  function Nf(a, b) {
    ...
    a: {
      var d = 0;
      var e = c + 3;
      for (var f = a.length; e < f; e++) if ('(' === a[e]) d++;
  ...
  function Tf(a, b, c) {
    if (b) if (a.classList) c ? (a.classList.remove('style-scope'), a.classList.remove(b))  : (a.classList.add('style-scope'), a.classList.add(b));
  ...
  function zg(a, b) {
    var c = a.m;
    if (c) {
      if (c.A) return Object.assign(b, c.A),
      !0
    } else {
      c = a.parsedCssText;
  ...
  function Dg(a, b, c, d) {
    ...
    if (b.m.A) {
      ...
      if (h || g) c = e,
      g && (b.o || (b.o = Zf(W, b, W.b, a ? Yf + a : '', e)), c = b.o || e),
      d({
        ab: c,
        Ua: g,
        tb: h
    ...
    return Vf(b, e, function (b) {
      ...
      if (!U && !Jf(b) && b.cssText) {
        ...
        if (b.ua) if (null == b.Z) {
          ...
          for (var n in g) k = g[n],
          k = k(e),
          e !== k && (e = k, b.Z.push(n))
        } else {
          for (n = 0; n < b.Z.length; ++n) k = g[b.Z[n]],
          e = k(e);
          k = e
        }
        b.cssText = k;
        ...
        n = b.o.split(',');
        k = 0;
        for (var t = n.length, C; k < t && (C = n[k]); k++) n[k] = C.match(h) ? C.replace(f, e)  : e + ' ' + C;
        b.selector = n.join(',')
      }
    })
  }
    ...
    for (var b = 0; b < a.length; b++) {
      ...
      if (c.target !== document.documentElement && c.target !== document.head) for (var d = 0; d < c.addedNodes.length; d++) {
        ...
        if (e.nodeType === Node.ELEMENT_NODE) {
          ...
          h = g;
          g = h.indexOf(W.a);
          if ((h = - 1 < g ? h[g + 1] : '') && f === e.ownerDocument) Rf(e, h, !0);
           else if (f.nodeType === Node.DOCUMENT_FRAGMENT_NODE && (f = f.host)) if (f = Pf(f).is, h === f) for (e = window.ShadyDOM.nativeMethods.querySelectorAll.call(e, ':not(.' + W.a + ')'), f = 0; f < e.length; f++) Tf(e[f], h);
           else h && Rf(e, h, !0),
          Rf(e, f)
        }
      }
  ...
  if (!U) {
    ...
    if (window.customElements && !window.customElements.polyfillWrapFlushCallback) Rg(document);
     else {
      var Sg = function () {
        Rg(document.body)
      };
  ...
  function Wg(a) {
    if (a = Ug[a]) a._applyShimCurrentVersion = a._applyShimCurrentVersion || 0,
  ...
  p.prepareTemplate = function (a, b, c) {
    if (!a.Ma) {
      ...
      V || (d = xg(a._styleAst));
      if (!d.length || V) e = U ? a.content : null,
      b = Kg[b],
      f = Vf(c, a._styleAst),
  ...
  p.I = function () {
    ...
    if (this.b) {
      ...
      if (this.b.enqueued) {
        ...
        } else for (fh(this, this.c, this.i), b = 0; b < a.length; b++) (c = this.b.getStyleForCustomStyle(a[b])) && Ig(c, this.i.F);
        this.b.enqueued = !1;
  ...
  p.styleElement = function (a, b) {
    ...
    if (V) {
      ...
      if (((k = Ug[c]) || a === this.c) && k && k.sa && !Xg(k)) {
        if (Xg(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion) dh(this),
  ...
  p.styleSubtree = function (a, b) {
    ...
    if (b = c && (c.children || c.childNodes)) for (a = 0; a < b.length; a++) this.styleSubtree(b[a]);
