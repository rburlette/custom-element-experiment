...
(function () {
  'use strict';
  var p, q = "undefined" != typeof window && window === this ? this : "undefined" != typeof global && null != global ? global : this, da = "function" == typeof Object.defineProperties ? Object.defineProperty : function (a, b, c) {
  ...
  function ha() {
      ...
      "function" != typeof Array.prototype[a] && da(Array.prototype, a, { configurable: !0, writable: !0, value: function () {
          return ia(this);
      } });
      ha = function () {
      };
  ...
  (function () {
      ...
      Object.assign || (Object.assign = function (a, b) {
          for (var c = [].slice.call(arguments, 1), d = 0, e; d < c.length; d++)
              if (e = c[d])
                  for (var f = a, m = e, n = Object.getOwnPropertyNames(m), t = 0; t < n.length; t++)
                      e = n[t], f[e] = m[e];
          return a;
      });
  ...
  (function () {
      ...
      function b(a, b) {
          if (!a.childNodes.length)
              return [];
          switch (a.nodeType) {
              case Node.DOCUMENT_NODE: return t.call(a, b);
              case Node.DOCUMENT_FRAGMENT_NODE: return C.call(a, b);
              default: return n.call(a, b);
          }
      }
      ...
      var f = Node.prototype.cloneNode, h = Document.prototype.createElement, g = Document.prototype.importNode, k = Node.prototype.removeChild, l = Node.prototype.appendChild, m = Node.prototype.replaceChild, n = Element.prototype.querySelectorAll, t = Document.prototype.querySelectorAll, C = DocumentFragment.prototype.querySelectorAll, aa = function () {
          if (!c) {
      ...
      if (c) {
          var P = document.implementation.createHTMLDocument("template"), Ka = !0, ba = document.createElement("style");
          ...
          var va = function (b) {
              ...
              Object.defineProperty(a, "outerHTML", { get: function () {
                  ...
                  if (this.parentNode) {
                      P.body.innerHTML = a;
                      for (a = this.ownerDocument.createDocumentFragment(); P.body.firstChild;)
          ...
          var hf = ba("area base br col command embed hr img input keygen link meta param source track wbr".split(" ")), xa = ba("style script xmp iframe noembed noframes plaintext noscript".split(" ")), nb = function (a, b) {
                  ...
                  a: {
                      ...
                      switch (g.nodeType) {
                          case Node.ELEMENT_NODE:
                              for (var m = g.localName, n = "<" + m, ya = g.attributes, Ma = 0; k = ya[Ma]; Ma++)
                          ...
                          case Node.COMMENT_NODE:
                              g = "\x3c!--" + g.data + "--\x3e";
                              break a;
                          default: throw window.console.error(g), Error("not implemented");
                      }
                  }
                  c += g;
              }
          ...
          var ya = function (c, d) {
              if (d.querySelectorAll && (d = b(d, "template"), 0 !== d.length)) {
                  ...
                  for (var e = 0, f = c.length, h, g; e < f; e++)
                      g = d[e], h = c[e], a && a.H && a.H(g), m.call(h.parentNode, Ma.call(g, !0), h);
              }
          }, Ma = Node.prototype.cloneNode = function (b) {
              if (!e && d && this instanceof DocumentFragment)
                  if (b)
                      var c = jf.call(this.ownerDocument, this, !0);
                  else
                      return this.ownerDocument.createDocumentFragment();
              else
                  c = this.nodeType === Node.ELEMENT_NODE && "template" === this.localName && this.namespaceURI == document.documentElement.namespaceURI ? a.ha(this, b) : f.call(this, b);
              b && ya(c, this);
              return c;
  ...
  var oa = Array.isArray ? Array.isArray : function (a) {
      return "[object Array]" === Object.prototype.toString.call(a);
  };
  var pa = 0, qa, ra = "undefined" !== typeof window ? window : void 0, sa = ra || {}, ta = sa.MutationObserver || sa.WebKitMutationObserver, ua = "undefined" !== typeof Uint8ClampedArray && "undefined" !== typeof importScripts && "undefined" !== typeof MessageChannel;
  function za() {
      return "undefined" !== typeof qa ? function () {
          qa(Aa);
      } : Ba();
  }
  function Ca() {
      var a = 0, b = new ta(Aa), c = document.createTextNode("");
  ...
  var Fa, Ga;
  if ("undefined" === typeof self && "undefined" !== typeof process && "[object process]" === {}.toString.call(process))
      Ga = function () {
  ...
  ;
  function Pa(a, b) {
      var c = this, d = new this.constructor(Qa);
      void 0 === d[Ra] && Sa(d);
      var e = c.h;
      if (e) {
          var f = arguments[e - 1];
  ...
  ;
  var Ra = Math.random().toString(36).substring(16);
  function Qa() {
  }
  var Ya = new Xa;
  function Za(a) {
  ...
  function bb(a, b) {
      1 === b.h ? r(a, b.f) : 2 === b.h ? u(a, b.f) : Ua(b, void 0, function (b) {
          return Wa(a, b);
      }, function (b) {
          return u(a, b);
      });
  ...
  function cb(a, b, c) {
      b.constructor === a.constructor && c === Pa && b.constructor.resolve === Va ? bb(a, b) : c === Ya ? (u(a, Ya.error), Ya.error = null) : void 0 === c ? r(a, b) : "function" === typeof c ? ab(a, b, c) : r(a, b);
  }
  function Wa(a, b) {
      if (a === b)
          ...
          var c = typeof b;
          null === b || "object" !== c && "function" !== c ? r(a, b) : cb(a, b, Za(b));
      }
  }
  function db(a) {
      a.ra && a.ra(a.f);
  ...
  function Ta(a, b, c, d) {
      ...
      if (e) {
          ...
          f = d, k = !0;
      void 0 === b.h && (e && k ? Wa(b, f) : h ? u(b, g) : 1 === a ? r(b, f) : 2 === a && u(b, f));
  }
  function gb(a, b) {
      try {
          b(function (b) {
  ...
  function ib(a, b) {
      ...
      this.D[Ra] || Sa(this.D);
      if (oa(b))
          if (this.U = this.length = b.length, this.f = Array(this.length), 0 === this.length)
              r(this.D, this.f);
          else {
              this.length = this.length || 0;
              for (a = 0; void 0 === this.h && a < b.length; a++)
                  jb(this, b[a], a);
              0 === this.U && r(this.D, this.f);
          }
      else
          u(this.D, Error("Array Methods must be provided an Array"));
  }
  function jb(a, b, c) {
      var d = a.Ia, e = d.resolve;
      e === Va ? (e = Za(b), e === Pa && void 0 !== b.h ? kb(a, b.h, c, b.f) : "function" !== typeof e ? (a.U--, a.f[c] = b) : d === v ? (d = new d(Qa), cb(d, b, e), lb(a, d, c)) : lb(a, new d(function (a) {
          return a(b);
      }), c)) : lb(a, e(b), c);
  }
  function kb(a, b, c, d) {
  ...
  v.prototype = { constructor: v, then: Pa, a: function (a) {
  ...
  subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
  */
  window.Promise || (window.Promise = v, v.prototype["catch"] = v.prototype.a, v.prototype.then = v.prototype.then, v.all = mb, v.race = ob, v.resolve = Va, v.reject = pb);
  (function (a) {
      function b(a, b) {
      ...
      function d(a) {
          var b = m(document, "link[rel=import]:not([import-dependency])"), c = b.length;
          c ? n(b, function (b) {
              return h(b, function () {
                  0 === --c && a();
              });
      ...
      function l(a) {
          n(m(a, "template"), function (a) {
              n(m(a.content, 'script:not([type]),script[type="application/javascript"],script[type="text/javascript"]'), function (a) {
      ...
      function n(a, b, c) {
          ...
          for (c = c ? d - 1 : 0; c < d && 0 <= c; c += e)
              b(a[c], c);
      }
      var t = document.createElement("link"), C = "import" in t, aa = t.querySelectorAll("*"), P = null;
      !1 === "currentScript" in document && Object.defineProperty(document, "currentScript", { get: function () {
          return P || ("complete" !== document.readyState ? document.scripts[document.scripts.length - 1] : null);
      }, configurable: !0 });
      var Ka = /(url\()([^)]*)(\))/g, ba = /(@import[\s]+(?!url\())([^;]*)(;)/g, La = /(<link[^>]*)(rel=['|"]?stylesheet['|"]?[^>]*>)/g, D = { Pa: function (a, b) {
          ...
          c = D.Fa;
          c || (c = document.implementation.createHTMLDocument("temp"), D.Fa = c, c.pa = c.createElement("base"), c.head.appendChild(c.pa), c.oa = c.createElement("a"));
          c.pa.href = b;
          c.oa.href = a;
          return c.oa.href || a;
      } }, va = { async: !0, load: function (a, b, c) {
          if (a)
              if (a.match(/^data:/)) {
                  a = a.split(",");
                  var d = a[1];
      ...
      k.prototype.s = function (a) {
          ...
          if (void 0 !== this.a[c]) {
              ...
              this.b++, this.a[c] = "pending", va.load(c, function (a, d) {
                  a = b.Wa(a, d || c);
                  b.a[c] = a;
                  b.b--;
                  b.loadImports(a);
      ...
      k.prototype.N = function () {
          ...
          if (!this.b) {
              ...
              var b = !1, c = !1, d = function () {
                  c && b && (a.loadImports(document), a.b || (a.c.observe(document.head, { childList: !0, subtree: !0 }), a.Ta()));
              };
              this.Ya(function () {
                  c = !0;
                  d();
      ...
      var wa = null;
      if (C)
          t = m(document, "link[rel=import]"), n(t, function (a) {
          ...
          Object.defineProperty((!ca || ca.configurable ? Node : Element).prototype, "baseURI", { get: function () {
              var a = g(this) ? this : c(this);
              return a ? a.href : ca && ca.get ? ca.get.call(this) : (document.querySelector("base") || window.location).href;
          }, configurable: !0, enumerable: !0 });
          Object.defineProperty(HTMLLinkElement.prototype, "import", { get: function () {
  ...
  */
  ...
  var qb = document.querySelector('script[src*="webcomponents-lite.js"]'), rb = /wc-(.+)/, w = {};
  if (!w.noOpts) {
  ...
  var vb = w.shadydom;
  vb && (window.ShadyDOM = window.ShadyDOM || {}, window.ShadyDOM.force = vb);
  var wb = w.register || w.ce;
  wb && window.customElements && (window.customElements.forcePolyfill = wb); /*
  ...
  */
  ...
  z.va = z.force || !z.Ra;
  var zb = navigator.userAgent.match("Trident"), Ab = navigator.userAgent.match("Edge");
  ...
  var Db = Element.prototype, Eb = Db.matches || Db.matchesSelector || Db.mozMatchesSelector || Db.msMatchesSelector || Db.oMatchesSelector || Db.webkitMatchesSelector;
  function Fb(a, b) {
      if (a && b)
  ...
  var Ib = document.createTextNode(""), Jb = 0, Kb = [];
  ...
  function Vb(a, b) {
      ...
      c.J.X.add(b);
      var d = c.J;
      return { Ga: b, G: d, Ka: a, takeRecords: function () {
  ...
  ;
  var B = {}, Yb = Element.prototype.insertBefore, Zb = Element.prototype.replaceChild, $b = Element.prototype.removeChild, ac = Element.prototype.setAttribute, bc = Element.prototype.removeAttribute, cc = Element.prototype.cloneNode, dc = Document.prototype.importNode, ec = Element.prototype.addEventListener, fc = Element.prototype.removeEventListener, gc = Window.prototype.addEventListener, hc = Window.prototype.removeEventListener, ic = Element.prototype.dispatchEvent, jc = Node.prototype.contains || HTMLElement.prototype.contains, kc = Document.prototype.getElementById, lc = Element.prototype.querySelector, mc = DocumentFragment.prototype.querySelector, nc = Document.prototype.querySelector, oc = Element.prototype.querySelectorAll, pc = DocumentFragment.prototype.querySelectorAll, qc = Document.prototype.querySelectorAll;
  ...
  B.querySelector = function (a) {
      switch (this.nodeType) {
          case Node.ELEMENT_NODE: return lc.call(this, a);
          case Node.DOCUMENT_NODE: return nc.call(this, a);
          default: return mc.call(this, a);
      }
  };
  B.pb = oc;
  B.sb = pc;
  ...
  B.querySelectorAll = function (a) {
      switch (this.nodeType) {
          case Node.ELEMENT_NODE: return oc.call(this, a);
          case Node.DOCUMENT_NODE: return qc.call(this, a);
          default: return pc.call(this, a);
      }
  };
  var rc = /[&\u00A0"]/g, sc = /[&\u00A0<>]/g;
  function tc(a) {
  ...
  var vc = uc("area base br col command embed hr img input keygen link meta param source track wbr".split(" ")), wc = uc("style script xmp iframe noembed noframes plaintext noscript".split(" "));
  function xc(a, b) {
      "template" === a.localName && (a = a.content);
      for (var c = "", d = b ? b(a) : a.childNodes, e = 0, f = d.length, h; e < f && (h = d[e]); e++) {
          a: {
              ...
              switch (g.nodeType) {
                  case Node.ELEMENT_NODE:
                      for (var m = g.localName, n = "<" + m, t = g.attributes, C = 0; k = t[C]; C++)
  ...
  ;
  var E = {}, F = document.createTreeWalker(document, NodeFilter.SHOW_ALL, null, !1), G = document.createTreeWalker(document, NodeFilter.SHOW_ELEMENT, null, !1);
  function yc(a) {
      var b = [];
      F.currentNode = a;
      for (a = F.firstChild(); a;)
      ...
      switch (a.nodeType) {
          ...
          case Node.DOCUMENT_FRAGMENT_NODE:
              ...
              for (var b = "", c; c = a.nextNode();)
                  b += c.nodeValue;
              return b;
          default: return a.nodeValue;
      }
  };
  var H = {}, zc = z.w, Ac = [Node.prototype, Element.prototype, HTMLElement.prototype];
  function I(a) {
      var b;
      a: {
      ...
      if (!b)
          throw Error("Could not find descriptor for " + a);
  ...
  H.children = function (a) {
      switch (a.nodeType) {
          ...
          case Node.DOCUMENT_NODE:
              ...
              break;
          default: a = J.children.get.call(a);
      }
      return Array.prototype.slice.call(a);
  };
  H.firstElementChild = function (a) {
      switch (a.nodeType) {
          case Node.DOCUMENT_FRAGMENT_NODE: return Bc.firstElementChild.get.call(a);
          case Node.DOCUMENT_NODE: return Cc.firstElementChild.get.call(a);
          default: return J.firstElementChild.get.call(a);
      }
  };
  H.lastElementChild = function (a) {
      switch (a.nodeType) {
          case Node.DOCUMENT_FRAGMENT_NODE: return Bc.lastElementChild.get.call(a);
          case Node.DOCUMENT_NODE: return Cc.lastElementChild.get.call(a);
          default: return J.lastElementChild.get.call(a);
      }
  };
  var K = z.Aa ? H : E;
  function Dc(a) {
  ...
  var Ec = z.w, Fc = document.implementation.createHTMLDocument("inert"), Gc = Object.getOwnPropertyDescriptor(Node.prototype, "isConnected"), Hc = Gc && Gc.get, Ic = Object.getOwnPropertyDescriptor(Document.prototype, "activeElement"), Jc = { parentElement: { get: function () {
      var a = y(this);
  ...
  }, configurable: !0 } }, Kc = { className: { get: function () {
      return this.getAttribute("class") || "";
  }, set: function (a) {
      this.setAttribute("class", a);
  }, configurable: !0 } }, Lc = { childNodes: { get: function () {
      if (Bb(this)) {
          var a = y(this);
          if (!a.childNodes) {
              a.childNodes = [];
      ...
      switch (this.nodeType) {
          ...
          case Node.DOCUMENT_FRAGMENT_NODE:
              if (!Bb(this) && Ec) {
                  ...
                  (b != this.lastChild || b && b.nodeType != Node.TEXT_NODE) && Dc(this);
                  H.wa.textContent.set.call(this, a);
              }
              else
                  Dc(this), (0 < a.length || this.nodeType === Node.ELEMENT_NODE) && this.appendChild(document.createTextNode(a));
              break;
      ...
      var a = Bb(this) ? Array.prototype.filter.call(this.childNodes, function (a) {
      ...
      return Bb(this) ? xc("template" === this.localName ? this.content : this) : K.innerHTML(this);
  }, set: function (a) {
      ...
      for (Ec ? H.wa.innerHTML.set.call(c, a) : c.innerHTML = a; c.firstChild;)
          b.appendChild(c.firstChild);
  }, configurable: !0 } }, Mc = { shadowRoot: { get: function () {
      var a = y(this);
      return a && a.xa || null;
  }, configurable: !0 } }, Nc = { activeElement: { get: function () {
      var a = Ic && Ic.get ? Ic.get.call(document) : z.w ? void 0 : document.activeElement;
      if (a && a.nodeType) {
          var b = !!A(this);
          if (this === document || b && this.host !== a && B.contains.call(this.host, a)) {
              for (b = Cb(a); b && b !== this;)
                  a = b.host, b = Cb(a);
  ...
  function Uc(a, b, c) {
      ...
      if (f = y(d.previousSibling))
          f.nextSibling = a;
      if (f = y(d.nextSibling = c))
          f.previousSibling = a;
      d.parentNode = b;
  ...
  function Vc(a, b) {
      ...
      if (void 0 === c.firstChild)
          for (b = b || Tc(a), c.firstChild = b[0] || null, c.lastChild = b[b.length - 1] || null, Sc(a), c = 0; c < b.length; c++) {
              var d = b[c], e = x(d);
              e.parentNode = a;
  ...
  function Xc(a, b, c) {
      ...
      if (!b.__noInsertionPoint) {
          if (f = e = Cb(a)) {
              var h;
              "slot" === b.localName ? h = [b] : b.querySelectorAll && (h = b.querySelectorAll("slot"));
              f = h && h.length ? h : void 0;
          }
          f && (h = e, d = f, h.v = h.v || [], h.g = h.g || [], h.j = h.j || {}, h.v.push.apply(h.v, [].concat(d instanceof Array ? d : na(ma(d)))));
      }
      ...
      g || (g = A(a) ? a.host : a, c ? (c = ad(c), B.insertBefore.call(g, b, c)) : B.appendChild.call(g, b));
      bd(a, b);
      return b;
  }
  function Yc(a, b) {
      ...
      if (Bb(a)) {
          ...
          var h = e.previousSibling, g = e.nextSibling;
          h && (x(h).nextSibling = g);
      ...
      k || (k = A(a) ? a.host : a, (!d.root && "slot" !== b.localName || k === Wc(b)) && B.removeChild.call(k, b));
      bd(a, null, b);
      return b;
  }
  function cd(a) {
      ...
      if (b && void 0 !== b.O) {
          b = a.childNodes;
          for (var c = 0, d = b.length, e; c < d && (e = b[c]); c++)
              cd(e);
      }
      if (a = y(a))
          a.O = void 0;
  ...
  function ad(a) {
      var b = a;
      a && "slot" === a.localName && (b = (b = (b = y(a)) && b.C) && b.length ? b[0] : ad(a.nextSibling));
      return b;
  }
  function $c(a) {
  ...
  function gd(a, b) {
      if ("slot" === b)
          a = a.parentNode, $c(a) && Zc(y(a).root);
  ...
  function jd(a) {
      if (a && a.nodeType) {
          var b = x(a), c = b.O;
          void 0 === c && (A(a) ? (c = a, b.O = c) : (c = (c = a.parentNode) ? jd(c) : a, B.contains.call(document.documentElement, a) && (b.O = c)));
          return c;
      }
  }
  function kd(a, b, c) {
  ...
  function sd(a, b) {
      ...
      for (var c = 0, d, e, f, h; c < b.length; c++)
          if (d = b[c], f = d === window ? window : d.getRootNode(), f !== e && (h = a.indexOf(f), e = f), !A(f) || -1 < h)
              return d;
  }
  var td = { get composed() {
  ...
  function xd(a, b, c) {
      if (c = b.__handlers && b.__handlers[a.type] && b.__handlers[a.type][c])
          for (var d = 0, e; (e = c[d]) && (!wd(a) || a.target !== a.relatedTarget) && (e.call(b, a), !a.i); d++)
              ;
  }
  function yd(a) {
      var b = a.composedPath();
      Object.defineProperty(a, "currentTarget", { get: function () {
          return d;
      }, configurable: !0 });
      ...
      if (b) {
          ...
          if ("function" === d || "object" === d)
              if ("object" !== d || b.handleEvent && "function" === typeof b.handleEvent) {
                  ...
                  b[pd].push({ node: g, type: a, capture: e, once: f, passive: h, hb: k });
                  vd[a] ? (this.__handlers = this.__handlers || {}, this.__handlers[a] = this.__handlers[a] || { capture: [], bubble: [] }, this.__handlers[a][e ? "capture" : "bubble"].push(k)) : (this instanceof Window ? B.fb : B.addEventListener).call(this, a, k, c);
              }
      }
  }
  function Cd(a, b, c) {
      if (b) {
          ...
          k && (e = zd(k, h, a, d, e, f), -1 < e && (g = k.splice(e, 1)[0].hb, k.length || (b[pd] = void 0)));
          (this instanceof Window ? B.gb : B.removeEventListener).call(this, a, g || b, c);
          g && vd[a] && this.__handlers && this.__handlers[a] && (a = this.__handlers[a][d ? "capture" : "bubble"], g = a.indexOf(g), -1 < g && a.splice(g, 1));
      }
  }
  function Dd() {
      for (var a in vd)
  ...
  var Ed = ud(window.Event), Fd = ud(window.CustomEvent), Gd = ud(window.MouseEvent);
  function Hd(a, b) {
  ...
  function Id(a, b, c, d) {
      ...
      if (b == a.length && d == c.length) {
          g = a.length;
          for (var l = c.length, m = 0; m < k - h && Jd(a[--g], c[--l]);)
              m++;
          g = m;
      }
      e += h;
      ...
      for (h = 0; h < a.length; h++)
          switch (a[h]) {
              ...
              case 2:
                  ...
                  e++;
                  break;
              case 3: b || (b = Hd(e, 0)), b.P.push(c[f]), f++;
          }
      b && k.push(b);
      return k;
  }
  ...
  ;
  var ed = K.parentNode, Kd = K.childNodes, Ld = {};
  function Md(a) {
      var b = [];
      do
          b.unshift(a);
  ...
  function Qc(a, b, c) {
      ...
      for (var d = a.length; c < d; c++)
          B.removeChild.call(b, a[c]);
  }
  function Zc(a) {
      a.V || (a.V = !0, Qb(function () {
          return Nd(a);
      }));
  }
  function Nd(a) {
  ...
  Qc.prototype._renderRoot = function () {
      ...
      if (this.g) {
          ...
          for (d = 0; d < a.length; d++)
              c = a[d].parentNode, (e = y(c)) && e.root || !(0 > b.indexOf(c)) || b.push(c);
  ...
  function id(a) {
      return a.sort(function (a, c) {
          ...
          for (var b = Md(c), e = 0; e < a.length; e++) {
              ...
              var f = b[e];
              if (c !== f)
                  return a = Array.from(c.parentNode.childNodes), a.indexOf(c) - a.indexOf(f);
          }
      });
  }
  function fd(a) {
  ...
  var Sd = { addEventListener: Ad.bind(window), removeEventListener: Cd.bind(window) }, Td = { addEventListener: Ad, removeEventListener: Cd, appendChild: function (a) {
      return Xc(this, a);
  ...
  Object.defineProperties(Td, { isConnected: { get: function () {
      if (Hc && Hc.call(this))
          return !0;
      ...
      if (Mb) {
          if (B.contains.call(a, this))
              return !0;
      }
      else if (a.documentElement && B.contains.call(a.documentElement, this))
          return !0;
      for (a = this; a && !(a instanceof Document);)
          a = a.parentNode || (A(a) ? a.host : void 0);
      return !!(a && a instanceof Document);
  }, configurable: !0 } });
  var Ud = { get assignedSlot() {
      return Rd(this);
  } }, Vd = { querySelector: function (a) {
  ...
  } }, Wd = { assignedNodes: function (a) {
      if ("slot" === this.localName) {
          var b = this.getRootNode();
          A(b) && Nd(b);
          return (b = y(this)) ? (a && a.flatten ? b.C : b.assignedNodes) || [] : [];
      }
  } }, Xd = Gb({ setAttribute: function (a, b) {
      nd(this, a, b);
  ...
  var Yd = Gb({ importNode: function (a, b) {
      return od(a, b);
  ...
  } }), ae = { addEventListener: function (a, b, c) {
  ...
  ;
  if (z.va) {
      var ShadyDOM = { inUse: z.va, patch: function (a) {
          Sc(a);
          Rc(a);
          return a;
      }, isShadyRoot: A, enqueue: Qb, flush: Rb, settings: z, filterMutations: Xb, observeChildren: Vb, unobserveChildren: Wb, nativeMethods: B, nativeTree: K };
      window.ShadyDOM = ShadyDOM;
      window.Event = Ed;
      window.CustomEvent = Fd;
      window.MouseEvent = Gd;
      Dd();
      var be = window.customElements && window.customElements.nativeHTMLElement || HTMLElement;
      M(Qc.prototype, ae);
      ...
      M(be.prototype, $d);
      z.w && (Oc(window.Node.prototype), Oc(window.Text.prototype), Oc(window.DocumentFragment.prototype), Oc(window.Element.prototype), Oc(be.prototype), Oc(window.Document.prototype), window.HTMLSlotElement && Oc(window.HTMLSlotElement.prototype));
      Pc();
      window.ShadowRoot = Qc;
  }
  ;
  var ce = new Set("annotation-xml color-profile font-face font-face-src font-face-uri font-face-format font-face-name missing-glyph".split(" "));
  function de(a) {
      var b = ce.has(a);
  ...
  function S(a, b, c) {
      c = void 0 === c ? {} : c;
      var d = c.eb || new Set, e = c.ba || function (b) {
          return ke(a, b);
      }, f = [];
      fe(b, function (b) {
  ...
  function le(a) {
      ...
      this.G = void 0;
      S(this.l, this.a);
      "loading" === this.a.readyState && (this.G = new MutationObserver(this.b.bind(this)), this.G.observe(this.a, { childList: !0, subtree: !0 }));
  }
  ...
  p.define = function (a, b) {
      ...
      b = { localName: a, constructor: b, connectedCallback: f, disconnectedCallback: h, adoptedCallback: g, attributeChangedCallback: k, observedAttributes: l, constructionStack: [] };
      he(this.l, a, b);
      this.ka.push(b);
      this.S || (this.S = !0, this.ja(function () {
          return ne(c);
      }));
  };
  p.ba = function (a) {
  ...
  p.Ba = function (a) {
      ...
      b = new me;
      this.ma.set(a, b);
      this.l.a.get(a) && !this.ka.some(function (b) {
  ...
  function We() {
      ...
      window.HTMLElement = function () {
          function b() {
              var b = this.constructor, d = a.s.get(b);
              if (!d)
                  throw Error("The custom element being constructed was not registered with `customElements`.");
              var e = d.constructionStack;
              if (0 === e.length)
                  return e = oe.call(document, d.localName), Object.setPrototypeOf(e, b.prototype), e.__CE_state = 1, e.__CE_definition = d, a.b(e), e;
              d = e.length - 1;
              var f = e[d];
              if (f === Ve)
  ...
  function $e() {
      ...
      O(Node.prototype, "replaceChild", function (b, d) {
          if (b instanceof DocumentFragment) {
              ...
              b = ze.call(this, b, d);
              if (N(this))
                  for (R(a, d), d = 0; d < c.length; d++)
                      Q(a, c[d]);
              return b;
          }
          c = N(b);
          var f = ze.call(this, b, d), h = N(this);
          h && R(a, d);
          c && R(a, b);
          h && Q(a, b);
          return f;
      });
      Ae && Ae.get ? b(Node.prototype, Ae) : ie(a, function (a) {
  ...
  function af(a) {
      ...
      void 0 !== Pe && O(b, "replaceWith", function (b) {
  ...
  function bf() {
      ...
      function d(b, c) {
          ...
          O(b, "insertAdjacentHTML", function (a, b) {
              ...
              if ("beforebegin" === a) {
                  ...
                  e = this.lastChild, c.call(this, a, b), d(e || this.firstChild, null);
              else if ("afterend" === a)
      ...
      Be && O(Element.prototype, "attachShadow", function (a) {
          return this.__CE_shadowRoot = a = Be.call(this, a);
      });
      Ce && Ce.get ? b(Element.prototype, Ce) : Se && Se.get ? b(HTMLElement.prototype, Se) : ie(a, function (a) {
          b(a, { enumerable: !0, configurable: !0, get: function () {
              return ve.call(this, !0).innerHTML;
          }, set: function (a) {
              var b = "template" === this.localName, c = b ? this.content : this, d = oe.call(document, this.localName);
      ...
      O(Element.prototype, "removeAttributeNS", function (b, c) {
          if (1 !== this.__CE_state)
              return Ie.call(this, b, c);
          var d = Ge.call(this, b, c);
          Ie.call(this, b, c);
          var e = Ge.call(this, b, c);
          d !== e && a.attributeChangedCallback(this, c, d, e, b);
      });
      Te ? c(HTMLElement.prototype, Te) : Je ? c(Element.prototype, Je) : console.warn("Custom Elements: `Element#insertAdjacentElement` was not patched.");
  ...
  if (!cf || cf.forcePolyfill || "function" != typeof cf.define || "function" != typeof cf.get) {
      var Xe = new ge;
      We();
      Ze();
  ...
  function sf(a, b, c) {
      ...
      if (a.cssText || a.rules) {
          ...
          if (f) {
              f = 0;
              for (var h = e.length, g; f < h && (g = e[f]); f++)
                  d = sf(g, b, d);
          }
          else
              b ? b = a.cssText : (b = a.cssText, b = b.replace(tf, "").replace(uf, ""), b = b.replace(vf, "").replace(wf, "")), (d = b.trim()) && (d = "  " + d + "\n");
      }
      d && (a.selector && (c += a.selector + " {\n"), c += d, a.selector && (c += "}\n\n"));
      return c;
  }
  var rf = 1, pf = 7, nf = 4, qf = 1E3, ff = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim, gf = /@import[^;]*;/gim, tf = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim, uf = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim, vf = /@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim, wf = /[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim, of = /^@[^\s]*keyframes/, mf = /\s+/g;
  var U = !(window.ShadyDOM && window.ShadyDOM.inUse), xf;
  function yf(a) {
      xf = a && a.shimcssproperties ? !1 : U || !(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/) || !window.CSS || !CSS.supports || !CSS.supports("box-shadow", "0 0 0 var(--foo)"));
  }
  ...
  var V = xf;
  var zf = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi, Af = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi, Bf = /(--[\w-]+)\s*([:,;)]|$)/gi, Cf = /(animation\s*:)|(animation-name\s*:)/, Df = /@media\s(.*)/, Ef = /\{[^}]*\}/g;
  var Ff = new Set;
  function Gf(a, b) {
      if (!a)
          return "";
  ...
  function Lf(a, b, c) {
      ...
      Mf ? a.compareDocumentPosition(Mf) === Node.DOCUMENT_POSITION_PRECEDING && (Mf = a) : Mf = a;
  }
  function Nf(a, b) {
      var c = a.indexOf("var(");
      if (-1 === c)
  ...
  function Sf(a, b, c, d) {
      ...
      if (b = "template" === b.localName ? (b.content || b.kb).childNodes : b.children || b.childNodes)
  ...
  function Tf(a, b, c) {
      if (b)
          if (a.classList)
              ...
              c ? d && (b = d.replace("style-scope", "").replace(b, ""), Of(a, b)) : Of(a, (d ? d + " " : "") + "style-scope " + b);
          }
  }
  function Vf(a, b, c) {
      var d = W, e = a.__cssBuild;
      U || "shady" === e ? b = Gf(b, c) : (a = Pf(a), b = Wf(d, b, a.is, a.R, c) + "\n\n");
      return b.trim();
  }
  ...
  Qf.prototype.b = function (a, b, c) {
      ...
      a = a.trim();
      var e = bg.test(a);
      e && (a = a.replace(bg, function (a, b, c) {
  ...
  function hg(a, b) {
      var c = a.match(mg);
      return (c = c && c[2].trim() || "") ? c[0].match(ng) ? a.replace(mg, function (a, c, f) {
          return b + f;
      }) : c.split(ng)[0] === b ? c : og : a.replace(dg, b);
  }
  function pg(a) {
  ...
  var bg = /:(nth[-\w]+)\(([^)]+)\)/, rg = ":not(.style-scope)", $f = ",", eg = /(^|[\s>+~]+)((?:\[.+?\]|[^\s>+~=[])+)/g, ng = /[[.:#*]/, dg = ":host", qg = ":root", gg = "::slotted", cg = new RegExp("^(" + gg + ")"), mg = /(:host)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/, jg = /(?:::slotted)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/, kg = /(.*):dir\((?:(ltr|rtl))\)/, Yf = ".", lg = ":", Uf = "class", og = "should_not_match", W = new Qf;
  function sg(a, b, c, d) {
      this.B = a || null;
      this.b = b || null;
      this.na = c || [];
  ...
  function Ag(a, b, c) {
      b && (b = 0 <= b.indexOf(";") ? Bg(a, b, c) : Nf(b, function (b, e, f, h) {
          if (!e)
              return b + h;
          (e = Ag(a, c[e], c)) && "initial" !== e ? "apply-shim-inherit" === e && (e = "inherit") : e = Ag(a, c[f] || f, c) || f;
          return b + (e || "") + h;
      }));
      return b && b.trim() || "";
  }
  ...
  function Cg(a, b) {
      ...
      Hf(a, function (a) {
          ...
          b && a.m.A && e && ug.call(b, e) && (zg(a, c), a = a.index, e = parseInt(a / 32, 10), d[e] = (d[e] || 0) | 1 << a % 32);
      }, null, !0);
      return { A: c, key: d };
  }
  function Dg(a, b, c, d) {
      ...
      if (b.m.A) {
          ...
          if (h || g)
              c = e, g && (b.o || (b.o = Zf(W, b, W.b, a ? Yf + a : "", e)), c = b.o || e), d({ ab: c, Ua: g, tb: h });
      }
  }
  function Eg(a, b) {
  ...
  function Fg(a, b, c, d) {
      var e = Pf(b), f = Xf(e.is, e.R), h = new RegExp("(?:^|[^.#[:])" + (b.extends ? "\\" + f.slice(0, -1) + "\\]" : f) + "($|[.:[\\s>+~])");
      e = X(b).B;
      var g = Gg(e, d);
  ...
  function Ig(a, b) {
      ...
      a.textContent = Gf(d, function (a) {
          ...
          a.m && a.m.cssText && (d = d.replace(tf, "").replace(uf, ""), a.cssText = Bg(c, d, b));
      });
  }
  q.Object.defineProperties(wg.prototype, { a: { configurable: !0, enumerable: !0, get: function () {
      return "x-scope";
  } } });
  var Jg = new wg;
  var Kg = {}, Lg = window.customElements;
  if (Lg && !U) {
      var Mg = Lg.define;
              ...
              for (var d = 0; d < c.addedNodes.length; d++) {
                  ...
                  if (e.nodeType === Node.ELEMENT_NODE) {
                      ...
                      if ((h = -1 < g ? h[g + 1] : "") && f === e.ownerDocument)
                          ...
                          if (f = Pf(f).is, h === f)
                              for (e = window.ShadyDOM.nativeMethods.querySelectorAll.call(e, ":not(." + W.a + ")"), f = 0; f < e.length; f++)
                                  Tf(e[f], h);
                          else
                              h && Rf(e, h, !0), Rf(e, f);
                  }
  ...
  if (!U) {
      var Qg = new MutationObserver(Pg), Rg = function (a) {
      ...
      if (window.customElements && !window.customElements.polyfillWrapFlushCallback)
          ...
          window.HTMLImports ? window.HTMLImports.whenReady(Sg) : requestAnimationFrame(function () {
  ...
  function Yg(a) {
      ...
      a.ta || (a.ta = !0, Vg.then(function () {
          a._applyShimCurrentVersion = a._applyShimNextVersion;
          a.ta = !1;
      }));
  }
  ;
  var Zg = null, $g = window.HTMLImports && window.HTMLImports.whenReady || null, ah;
  function bh(a) {
      requestAnimationFrame(function () {
          $g ? $g(a) : (Zg || (Zg = new Promise(function (a) {
              ah = a;
          }), "complete" === document.readyState ? ah() : document.addEventListener("readystatechange", function () {
      ...
      if (!a.Ma) {
          ...
          for (var f = a.content.querySelectorAll("style"), h = 0; h < f.length; h++) {
              ...
              if (g.hasAttribute("shady-unscoped")) {
                  if (!U) {
                      var k = g.textContent;
                      Ff.has(k) || (Ff.add(k), k = g.cloneNode(!0), document.head.appendChild(k));
                      g.parentNode.removeChild(g);
                  }
              }
              else
                  e.push(g.textContent), g.parentNode.removeChild(g);
          }
          e = e.join("").trim();
          ...
          V || (d = xg(a._styleAst));
          if (!d.length || V)
              e = U ? a.content : null, b = Kg[b], f = Vf(c, a._styleAst), b = f.length ? Kf(f, c.is, e, b) : void 0, a.sa = b;
          a.La = d;
      }
  };
  function eh(a) {
  ...
  function dh(a) {
      !a.a && window.ShadyCSS && window.ShadyCSS.ApplyShim && (a.a = window.ShadyCSS.ApplyShim, a.a.invalidCallback = Wg);
      eh(a);
  }
  p.I = function () {
      dh(this);
      ...
      if (V) {
          ...
          if (((k = Ug[c]) || a === this.c) && k && k.sa && !Xg(k)) {
              if (Xg(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion)
                  dh(this), this.a && this.a.transformRules(k._styleAst, c), k.sa.textContent = Vf(a, d.B), Yg(k);
              U && (c = a.shadowRoot) && (c.querySelector("style").textContent = Vf(a, d.B));
              d.B = k._styleAst;
          }
      }
          ...
          f = X(a);
          var l = f.a;
          l && !U && l !== d && (l._useCount--, 0 >= l._useCount && l.parentNode && l.parentNode.removeChild(l));
          U ? f.a ? (f.a.textContent = e, d = f.a) : e && (d = Kf(e, g, a.shadowRoot, f.b)) : d ? d.parentNode || (vg && -1 < e.indexOf("@media") && (d.textContent = e), Lf(d, null, f.b)) : e && (d = Kf(e, g, null, f.b));
          d && (d._useCount = d._useCount || 0, f.a != d && d._useCount++, f.a = d);
          g = d;
          U || (d = c.u, f = e = a.getAttribute("class") || "", h && (f = e.replace(new RegExp("\\s*x-scope\\s*" + h + "\\s*", "g"), " ")), f += (f ? " " : "") + "x-scope " + d, e !== f && Of(a, f));
  ...
  var Z = new Y, hh, ih;
  window.ShadyCSS && (hh = window.ShadyCSS.ApplyShim, ih = window.ShadyCSS.CustomStyleInterface);
  ...
  var jh = window.customElements, kh = window.HTMLImports, lh = window.HTMLTemplateElement;
