...
class compBinder extends binder {
    constructor(element, owner) {
        super(element, function() {}, null);
        this.owner = owner;
    }
    ...
    initialize() {
        this.node.appendChild(document.getElementById('ch-timecard').content.cloneNode(true));
        this.boundRoot = new boundElement(this.node, this.owner);
    }
                ...
                case 1:
                    switch(node.nodeName) {
                        ...
                        case 'SCRIPT':
                            return NodeFilter.FILTER_REJECT;
                        default:
                            if(node.nodeName === "CH-TIMECARD") {
                                _this.children.push(new compBinder(node, new chTimeCard()));
                                return NodeFilter.FILTER_REJECT;
                            }
